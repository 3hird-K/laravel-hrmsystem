      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="row col-xl-4 col-lg-12">
              <div class="row-md-6">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-category">
                      <span class="text-success"><i class="fa fa-long-arrow-up"></i> Overflow Home Office </span> Monitoring
                    </p>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">access_time</i> Today is : <span id="current-date"></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="col-xl-4 col-lg-12">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">HR Management System</h4>
                    <p class="card-category">
                      <span class="text-success"><i class="fa fa-long-arrow-up"></i> Overflow Home Office </span> Monitoring</p>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">access_time</i> Today is : <span id="current-date"></span>
            ...
            <div class="col-xl-8 col-lg-12">
              <div class="card card-chart">
                  ...
                  <div class="row justify-content-between">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                      <a class="nav-link" href="javascript:void(0)" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <button type="button" class="btn btn-dark text-white dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                          <span class="visually-hidden"><i class="material-icons">update</i>Clock In/Out</span>
                        </button>
                      </a>
                      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="javascript:void(0)"><i class="material-icons">login</i>Clock-in</a>
                        <!-- <a class="dropdown-item" href="javascript:void(0)">Break</a> -->
                        <a class="dropdown-item" href="javascript:void(0)"><i class="material-icons">logout</i>Clock-out</a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row ">
                      ...
                      <div class="row">
                        <div class="col-md-3 my-3">
                          <div class="nav-item dropdown">
                            ...
                            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false" id="employeeDropdown">
                              <span class="visually-hidden"><i class="material-icons">person</i>Select an Employee</span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="employeeDropdown">
                              @if ($employees->count() > 0)
                              @foreach ($employees as $employee_item)
                              <a class="dropdown-item" href="javascript:void(0)" onclick="selectEmployee('{{ $employee_item->fname . ',' . $employee_item->lname }}')">{{ $employee_item->fname . ' ' . $employee_item->lname }}</a>
                              @endforeach
                              @else
                              <a href="javascript:void(0)" class="dropdown-item" disabled>No Employee Available</a>
                              @endif
                            </div>
                          </div>
                        </div>
                        <div class="col-md-8 d-flex justify-content-end">
                          <input type="text" class="form-control" name="employee" id="employeeInput" placeholder="Select Employee" disabled>
                    ...
                    <div class="col-12">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row"><span id="current-date">6/12/24</span></th>
                            <td>Clock-In</td>
                            <td>9:50PM</td>
                          </tr>
                          <tr>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">edit_calendar</i><a class="text-success" data-background-color="danger" href="#">Show Team Attendance</a>
                  </div>
                  <div>
                    <button type="submit" class="btn btn-primary"><i class="material-icons">radio_button_checked</i>Record</button>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="card card-stats">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h3 class="card-title"><span class="text-white fw-bold">{{ count($admins) }}</span>
            ...
            <div class="col-md-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title"><span class="text-white fw-bold">{{ count($supervisors) }}</span>
                    <small>Accounts</small>
                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons text-warning">supervised_user_circle</i>Enrolled Supervisors
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title"><span class="text-white fw-bold">{{ count($employees) }}</span>
                    <small>Accounts</small>
                  </h3>
                </div>
                <div class="card-footer">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Human Resource Accounts <span class="text-white fw-bold">{{ count($hr_user) }}</span></h4>
