                            ...
                            <div class="col-md-11">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <p class="card-category">Updated employees data as of <span
                                                    ...
                                                    @if (count($employees) > 0)
                                                        @foreach ($employees as $employee_item)
                                                            <tr class="py-5">
                                                                ...
                                                                <td class="py-2"><img src="{{ $employee_item->image }}"
                                                                        alt="Profile" class="rounded" height="50px"
                                                                        width="50px"></td>
                                                                <td>{{ $employee_item->fname . ' ' . $employee_item->lname }}
                                                                </td>
                                                                ...
                                                                {{-- <td>
                                                                    @foreach ($supervisors as $supervisor_item)
                                                                        {{ $supervisor_item->department_name }}
                                                                    @endforeach
                                                                </td> --}}
                                                                <td>
                                                                    @if ($employee_item->supervisor)
                                                                        {{ $employee_item->supervisor->firstname }}
                                                                        {{ $employee_item->supervisor->lastname }}
                                                                    @else
                                                                ...
                                                                <td>
                                                                    <a href="#" class="btn btn-success btn-sm"
                                                                        ...
                                                                        data-bs-target="#editEmployeeModal{{ $employee_item->id }}">Update</a>
                                                                    <a href="/deletes/{{ $employee_item->id }}"
                                                                        class="btn btn-danger btn-sm"
                                                                        onclick="return confirm('Are you sure?')">Delete</a>
                                                                    <!-- Edit Employee Modal -->
                                                                    <div class="modal fade"
                                                                        id="editEmployeeModal{{ $employee_item->id }}"
                                                                        tabindex="-1"
                                                                        aria-labelledby="editEmployeeModalLabel{{ $employee_item->id }}"
                                                                        aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h1 class="modal-title"
                                                                                        id="editEmployeeModalLabel{{ $employee_item->id }}">
                                                                                        Edit Employee</h1>
                                                                                    <button type="button"
                                                                                        class="btn-close"
                                                ...
                                                <tbody>
                                                    @if (count($supervisors) > 0)
                                                        @foreach ($supervisors as $supervisor_item)
                                                            <tr>
                                                                <td>{{ $loop->iteration }}</td>
                                                                <td><img src="{{ $supervisor_item->image }}"
                                                                        alt="Profile" class="rounded" height="50px"
                                                                        width="50px"></td>
                                                                <td>{{ $supervisor_item->firstname . ' ' . $supervisor_item->lastname }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="btn btn-success btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#editSupervisorModal{{ $supervisor_item->id }}">Update</a>
                                                                    <a href="/delete/{{ $supervisor_item->id }}"
                                                                        class="btn btn-danger btn-sm"
                                                                        onclick="return confirm('Are you sure?')">Delete</a>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <div class="modal fade"
                                                                id="editSupervisorModal{{ $supervisor_item->id }}"
                                                                tabindex="-1"
                                                                aria-labelledby="editSupervisorModalLabel{{ $supervisor_item->id }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-secondary text-white">
                                                                            <h5 class="modal-title"
                                                                                id="editSupervisorModalLabel{{ $supervisor_item->id }}">
                                                                                Edit Supervisor</h5>
                                                                        ...
                                                                        <div class="modal-body bg-dark">
                                                                            <form
                                                                                action="{{ route('supervisor.update', $supervisor_item->id) }}"
                                                                                method="POST"
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="bmd-label-floating">First
                                                                                                Name</label>
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name="firstname"
                                                                                                value="{{ $supervisor_item->firstname }}">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="bmd-label-floating">Last
                                                                                                Name</label>
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name="lastname"
                                                                                                value="{{ $supervisor_item->lastname }}">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="bmd-label-floating">Handled
                                                                                                Position/s</label>
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name="position"
                                                                                                value="{{ $supervisor_item->position }}">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="bmd-label-floating">Contact
                                                                                                #</label>
                                                                                            <input type="tel"
                                                                                                class="form-control"
                                                                                                pattern="09[0-9]{9}"
                                                                                                name="contact"
                                                                                                value="{{ $supervisor_item->contact }}">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name="address"
                                                                                                value="{{ $supervisor_item->address }}">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <label for="upload_photo">Upload
                                                                                            Profile</label>
                                                                                        <input type="file"
                                                                                            id="upload_photo"
                                                                                            class="form-control"
                                                                                            name="supervisor-profile"
                                                                                            value="{{ $supervisor_item->image }}">
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <img src="{{ $supervisor_item->image }}"
                                                                                            alt="" height="100px"
                                                                                            width="100px"
                                                                                            class="rounded">
                                                                                    </div>
                        ...
                        <footer class="footer">
                            <div class="container-fluid">
                                ...
                                <div class="copyright float-right" id="date">
                                    ...
                                    <a href="https://3hird-k.github.io/web-sys-project-edition1/" target="_blank">VS</a>
                                    IT
                                    Department.
                                </div>
                            </div>
