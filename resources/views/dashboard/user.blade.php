...
@section('dashboard-content')
                                    ...
                                    <form action="{{ route('employee.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control w-100"
                                                                name="supervisor_id" id="supervisorInput" required
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="nav-item dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    aria-labelledby="supervisorDropdown">
                                                                    @if ($supervisors->count() > 0)
                                                                        @foreach ($supervisors as $supervisor_item)
                                                                            <a class="dropdown-item"
                                                                                href="javascript:void(0)"
                                                                                onclick="selectSupervisor('{{ $supervisor_item->firstname . ',' . $supervisor_item->lastname }}')"
                                                                                name="supervisor_id">{{ $supervisor_item->firstname . ' ' . $supervisor_item->lastname }}</a>
                                                                        @endforeach
                                                                    @else
                                                                        <a href="javascript:void(0)" class="dropdown-item"
                                                                            disabled>No Supervisors</a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <input type="hidden" id="supervisorInput"
                                                                name="supervisor_id">
                                                            <input type="text" class="form-control w-100"
                                                                id="supervisorRealInput" required
                                                                placeholder="Select Supervisor">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="nav-item dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    @if ($supervisors->count() > 0)
                                                                        @foreach ($supervisors as $supervisor_item)
                                                                            <a class="dropdown-item"
                                                                                href="javascript:void(0)"
                                                                                onclick="selectSupervisor('{{ $supervisor_item->id }}', '{{ $supervisor_item->firstname . ' ' . $supervisor_item->lastname }}')">
                                                                                {{ $supervisor_item->firstname . ' ' . $supervisor_item->lastname }}
                                                                            </a>
                                                                        @endforeach
                                                                    @else
                                                                        <a href="javascript:void(0)" class="dropdown-item"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" placeholder="dd/mm/yyyy"
                                                        class="form-control text-gray text-center fs-6" name="date_hired">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row my-4">
                                            ...
                                            <div class="col-md-12 d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <input type="file" id="upload_photo" class="form-control-file"
                                                        name="employee-profile" required style="display: none;" required>
                                                    <label id="file-name" class="form-label text-muted">No file
                                                        chosen</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating"> Important Information or notes
                                                            on this employee</label>
                                            ...
                                            <div class="col-md-12 d-flex justify-content-center">
                                                ...
                                                @if (Session::has('approved'))
                                                    <span
                                                        class="alert alert-primary mt-5">{{ Session::get('approved') }}</span>
                                                @endif

                                                @if (Session::has('failed'))
                                                    <span
                                                        class="alert alert-danger mt-5">{{ Session::get('failed') }}</span>
                                                @endif
                                    ...
                                    <form action="{{ route('supervisor.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row col-md-6">
                                                <div class="col-md-8">
                                                    {{-- <input type="text" class="form-control w-100"
                                                        placeholder="Select Department ->" id="departmentInput"
                                                        name="department_id">
                                                    <input type="text" class="form-control w-100"
                                                        placeholder="Select Department ->" id="departmentIRealnput"
                                                        name='department_id'> --}}
                                                    <input type="hidden" id="departmentInput" name="department_id">
                                                    <input type="text" class="form-control w-100"
                                                        placeholder="Selected Department ->" id="departmentRealInput"
                                                ...
                                                <div class="col-md-2 align-self-end">
                                                    <div class="nav-item dropdown">
                                                        <button type="button"
                                                            ...
                                                            id="supervisorDropdown">
                                                            <span class="visually-hidden"><i
                                                                    class="material-icons">store</i></span>
                                                        </button>
                                                        <div class="dropdown-menu" aria-labelledby="supervisorDropdown">
                                                            @if ($departments->count() > 0)
                                                                @foreach ($departments as $department)
                                                                    <a class="dropdown-item" href="#"
                                                                        onclick="selectDepartment('{{ $department->id }}', '{{ $department->department_name }}')">{{ $department->department_name }}</a>
                                                                @endforeach
                                                            @else
                                                                <a href="#" class="dropdown-item" disabled>No
                                                                    Departments</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <input type="file" id="upload_photos" class="form-control-file"
                                                        name="supervisor-profile" required style="display: none;">
                                                    <label id="file-names" class="form-label text-muted">No file
                                                        chosen</label>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        // }
        function selectSupervisor(supervisor_id, supervisor_name) {
            document.getElementById('supervisorInput').value = supervisor_id;
            document.getElementById('supervisorRealInput').value = supervisor_name;
        }


        function selectDepartment(department_id, department_name) {
            document.getElementById('departmentInput').value = department_id;
            document.getElementById('departmentRealInput').value = department_name;
        }

        // function selectDepartment(department_id, department_name) {
        //     document.getElementById('departmentInput').value = department_id;
        //     document.getElementById('departmentRealInput').value = department_name;
        //     // document.getElementById('departmentRealInput').value = deparment_name;
        // }
